...
class LibarchiveConan(ConanFile):
    ...
    def _patch_sources(self):
        ...
        files.replace_in_file(self, cmakelists_path,
        ...
        if self.options.with_lzma:
            files.replace_in_file(self, cmakelists_path, "LIBLZMA_INCLUDE_DIR", "LIBLZMA_INCLUDE_DIRS")
        ...
        if self.options.shared:
            files.save(self, os.path.join(self._source_subfolder, "libarchive", "CMakeLists.txt"),
        ...
        if self.options.shared:
            files.replace_in_file(self, os.path.join(self._source_subfolder, "libarchive", "CMakeLists.txt"),
