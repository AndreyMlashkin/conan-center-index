...
class MozillaBuildConan(ConanFile):
    ...
    def build(self):
        ...
        files.download(self, **self.conan_data["sources"][self.version][0], filename=filename)
        files.download(self, **self.conan_data["sources"][self.version][1], filename="LICENSE")
