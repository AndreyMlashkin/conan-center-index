...
class PopplerConan(ConanFile):
    ...
    def _configure_cmake(self):
        ...
        if self.options.with_openjpeg:
            ...
            self._cmake.definitions["OPENJPEG_MAJOR_VERSION"] = Version(self.requires["openjpeg"].ref.version).major
        ...
        self._cmake.definitions["ENABLE_QT5"] = self.options.with_qt and Version(self.deps_cpp_info["qt"].version).major == "5"
        self._cmake.definitions["ENABLE_QT6"] = self.options.with_qt and Version(self.deps_cpp_info["qt"].version).major == "6"
    ...
    def _patch_sources(self):
        ...
        if Version(self.version) < "21.07.0" and not self.options.shared:
            ...
            files.replace_in_file(self, poppler_global, "__declspec(dllimport)", "")
            files.replace_in_file(self, poppler_global, "__declspec(dllexport)", "")
