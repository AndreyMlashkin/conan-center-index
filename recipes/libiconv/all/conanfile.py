...
class LibiconvConan(ConanFile):
    ...
    def _use_winbash(self):
        return tools.os_info.is_windows and (self.settings.compiler == "gcc" or tools.build.cross_building(self))
    ...
    def _build_context(self):
        ...
        if not tools.build.cross_building(self) or is_msvc(self) or self._is_clang_cl:
            rc = None
