...
class XtrConan(ConanFile):
    ...
    def requirements(self):
        ...
        if Version(self.version) >= "2.0.0" and self.settings.os == "Linux" and self.options.get_safe("enable_io_uring"):
    ...
    def validate(self):
        ...
        if Version(self.version) < "2.0.0" and self.settings.compiler == "clang" and self.settings.compiler.libcxx == "libc++":
