...
class LibZipConan(ConanFile):
    ...
    def _patch_sources(self):
        ...
        if self._has_zstd_support:
            ...
            files.replace_in_file(self, top_cmakelists, "find_package(Zstd)", "find_package(zstd)")
            files.replace_in_file(self, top_cmakelists, "Zstd_FOUND", "zstd_FOUND")
            files.replace_in_file(self, lib_cmakelists, "Zstd::Zstd", "zstd::zstd")
