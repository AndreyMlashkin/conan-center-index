...
class ScnlibConan(ConanFile):
    ...
    def _compilers_minimum_version(self):
        return {
            "gcc": "5",
            "clang": "6.0",
            "Visual Studio": "16" if Version(self.version) >= "1.0" else "15",
        }
    ...
    def package(self):
        ...
        if Version(self.version) >= "1.0":
            files.rm(self, "*.cmake", os.path.join(self.package_folder, "include", "scn", "detail"))
            files.rmdir(self, os.path.join(self.package_folder, "include", "scn", "detail", "CMakeFiles"))
            files.rmdir(self, os.path.join(self.package_folder, "include", "scn", "detail", "deps", "CMakeFiles"))
