...
class TrantorConan(ConanFile):
    ...
    def validate(self):
        ...
        if self.settings.compiler == "Visual Studio" and Version(self.settings.compiler.version) == "16" and \
    ...
    def _patch_sources(self):
        ...
        files.replace_in_file(self, cmakelists, "c-ares_lib", "c-ares::cares")
        # Cleanup rpath in shared lib
        files.replace_in_file(self, cmakelists, "set(CMAKE_INSTALL_RPATH \"${CMAKE_INSTALL_PREFIX}/${INSTALL_LIB_DIR}\")", "")
