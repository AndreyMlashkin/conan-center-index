...
class CapnprotoConan(ConanFile):
    ...
    def build(self):
        ...
        if self.settings.os == "Windows":
            ...
            with files.chdir(self, os.path.join(self._source_subfolder, "c++")):
    ...
    def package(self):
        ...
        """)
        files.replace_in_file(self, os.path.join(self.package_folder, self._cmake_folder, "CapnProtoMacros.cmake"),
                              "function(CAPNP_GENERATE_CPP SOURCES HEADERS)",
                              find_execs)
