...
class OpenEXRConan(ConanFile):
    ...
    def validate(self):
        if Version(self.version) < "2.5.0" and hasattr(self, "settings_build") and tools.build.cross_building(self):
    ...
    def _patch_sources(self):
        ...
        if pkg_version < "2.5.2" and self.settings.os == "Windows":
            ...
            for lib in ("OpenEXR", "IlmBase"):
                files.replace_in_file(self, os.path.join(self._source_subfolder,  lib, "config", "LibraryDefine.cmake"),
