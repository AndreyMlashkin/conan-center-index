...
class QcustomplotConan(ConanFile):
    ...
    def requirements(self):
        if int(Version(self.version).major) >= 2:
    ...
    def validate(self):
        if self.settings.compiler.get_safe("cppstd"):
            min_cppstd = "11" if Version(self.deps_cpp_info["qt"].version) < "6.0.0" else "17"
    ...
    def _patch_sources(self):
        ...
        if int(Version(self.version).major) >= 2:
            ...
            files.replace_in_file(self, os.path.join(self._source_subfolder, "qcustomplot.h"),
