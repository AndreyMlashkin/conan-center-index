...
class Pthreads4WConan(ConanFile):
    ...
    def build(self):
        with files.chdir(self, self._source_subfolder):
            if self.settings.compiler == "Visual Studio":
                files.replace_in_file(self, "Makefile",
                ...
                files.replace_in_file(self, "Makefile", "XCFLAGS=\"/MD\"", "")
                files.replace_in_file(self, "Makefile", "XCFLAGS=\"/MDd\"", "")
                files.replace_in_file(self, "Makefile", "XCFLAGS=\"/MT\"", "")
                files.replace_in_file(self, "Makefile", "XCFLAGS=\"/MTd\"", "")
                target = {
                    "CPP": "VCE",
                    "SEH": "SSE",
