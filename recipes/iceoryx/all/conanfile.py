...
class IceoryxConan(ConanFile):
    ...
    def _patch_sources(self):
        ...
        for cmake_file in [
            ...
            files.replace_in_file(self, os.path.join(self._source_subfolder, cmake_file), "POSITION_INDEPENDENT_CODE ON", "")
    ...
    def package(self):
        ...
        if self.options.toml_config:
            ...
            files.rename(self, os.path.join(self.package_folder, "etc", "roudi_config_example.toml"),
